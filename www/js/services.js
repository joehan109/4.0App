...
.factory('AuthService', function($rootScope, ENV, $http, Storage, $state, $q, FetchData, ngCart, $timeout) {
...
.factory('Items', function(ENV, $http, $log, $q, $rootScope, Storage) {
    ...
    .factory('FetchData', function($rootScope, $http, $q, ENV, $ionicLoading, $state, Storage) {
        return {
...
.service('device',function($rootScope, $http) {
    var browser = {  
        versions: function() {  
...
.factory("appUpdateService", function($ionicPopup, $timeout, $ionicLoading, device) {
    var version;
    ...
    function checkUpdate() {
        ...
        // $http.get('/getVersion').then(funtcion (res) {
        //     if (res.status) {
        //         if (device.isIos) {  
        //             setTimeout(function () {
