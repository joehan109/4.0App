...
angular.module('fourdotzero', ['ionic', 'ionic.service.core', 'ngCordova',
    ...
    'fourdotzero.constants', 'fourdotzero.filters', 'tag-select'
])
...
.run(['$ionicPlatform', '$rootScope', '$state', 'JPush', '$ionicHistory', '$ionicModal', '$ionicLoading', '$cordovaToast', 'amMoment', 'AuthService', 'ngCart', 'Storage', 'FetchData', '$ionicSlideBoxDelegate', '$cordovaBarcodeScanner', 'orderOpt', 'AlipayService', function($ionicPlatform, $rootScope, $state, JPush,
    ...
    $rootScope.$on('authDialog:hide', function(event) {})
...
$templateCache.put("order.html","<ion-view>\n    <div class=\"bar bar-header\">\n        <button class=\"button button-clear icon ion-ios-arrow-back\" ng-click=\"$state.go(\'tab.orders\')\"></button>\n        <div class=\"title\">订单详情</div>\n    </div>\n\n    <ion-content class=\"has-header\">\n\n        <section class=\"orders\">\n            <div class=\"checkout-info\">\n                <div class=\"address-info-1\">\n                    <div class=\"row\">\n                        <div class=\"col\">收货人：{{order.receiptName}}</div>\n                        <div class=\"col\" style=\"text-align:right\">{{order.receiptPhone}}</div>\n                    </div>\n                    <div class=\"row\">\n                        <div class=\"col\">收货地址：{{order.receiptDetail}}</div>\n                    </div>\n                </div>\n            </div>\n        </section>\n\n        <section class=\"clearfix\" ng-cloak>\n            <div class=\"\">\n                <table class=\"table ngCart cart-table\">\n                    <tbody>\n                        <tr ng-repeat=\"entry in order.detailList track by $index\">\n                            <td class=\"img-cell\">\n                                <div>\n                                    <img ng-src=\"{{entry.maProImg}}\">\n                                </div>\n                            </td>\n                            <td class=\"info-cell\">\n                                <div>{{ entry.maProName }}</div>\n                            </td>\n                            <td class=\"price-cell\">\n                                {{ entry.dealPrice | currency:\"￥\" }}\n                                <div style=\"color:#333\">\n                                    <span>x {{ entry.num | number }}</span>\n                                </div>\n                            </td>\n                        </tr>\n                </table>\n            </div>\n        </section>\n        <section>\n            <div class=\"checkout-info\">\n                <div class=\"partner-info\" style=\"margin-left: 8px;\">\n                    <div class=\"selected-partner\">快递方式:{{order.trackingTypeStr}}\n                        <span class=\"detail-price pull-right\">{{order.trackingAmount | currency:\'￥\' }}</span>\n                    </div>\n                </div>\n            </div>\n        </section>\n\n        <section>\n            <!-- <div class=\"checkout-info\">\n    <div class=\"item-info-table\">\n        <dl class=\"item-info-field\">\n            <dt class=\"\">商品总价: </dt>\n            <dd class=\"detail-price\">{{ngCart.getSubTotal() | currency:\'￥\' }}</dd>\n        </dl>\n        <dl class=\"item-info-field\">\n            <dt class=\"\">运费: </dt>\n            <dd class=\"detail-price\">{{order.trackingAmount | currency:\'￥\' }}</dd>\n        </dl>\n    </div>\n</div> -->\n            <div class=\"order-bottom\">\n                <div class=\"\">\n                    订单号：{{order.code}}\n                </div>\n                <div class=\"\">\n                    创建时间: {{order.createTime}}\n                </div>\n            </div>\n        </section>\n    </ion-content>\n    <ion-footer-bar align-title=\"left\" class=\"bar-stable\">\n        <a class=\"button button-clear\">\n        总计: <span class=\"footer-price\"> {{ order.totalAmount |currency:\'￥\'}}</span>\n    </a>\n        <h1 class=\"title\"></h1>\n        <div class=\"buttons orderButtons\">\n            <ngcart-checkout ng-if=\"order.status==\'0\'\" settings=\"{ order_id: order.id , order_type: \'existed\'}\" ordertype=\"existed\" orderid={{order.id}}>\n                去付款\n            </ngcart-checkout>\n            <button class=\"button button-default\" style=\"border:1px solid #aaa\" href=\"#/order/logistics/{{order.code}}\" ng-if=\"order.status==\'1\' || order.status==\'2\'\">\n                查看物流\n            </button>\n            <button class=\"button button-energized\" ng-click=\"doneOrder()\" ng-if=\"order.status==\'1\' || order.status==\'2\'\">\n                确认收货\n            </button>\n            <button class=\"button button-default\" style=\"border:1px solid #aaa\" ng-click=\"cancelOrder()\" ng-if=\"order.status==\'0\'\">\n                取消订单\n            </button>\n            <button class=\"button button-energized\" ng-click=\"delOrder()\" ng-if=\"order.status==\'3\'\">\n                删除订单\n            </button>\n        </div>\n    </ion-footer-bar>\n</ion-view>");
$templateCache.put("orders.html","<!-- 商品详情 -->\n<ion-view>\n    <div class=\"bar bar-header\">\n        <button class=\"button button-clear icon ion-ios-arrow-back\" ng-click=\"goTo()\"></button>\n        <div class=\"title\">我的订单</div>\n    </div>\n\n    <ion-content class=\"has-header\">\n\n        <section>\n            <div class=\"order-btn-row\">\n                <div class=\"btn-group cart-btn row\" style=\"display:flex;padding:0 10px\">\n                    <button class=\"btn order-btn col-25\" ng-class=\"{\'active\': orderType == \'0\'}\" ng-click=\"setType(\'0\')\">待付款</button>\n                    <button class=\"btn order-btn col-25\" ng-class=\"{\'active\': orderType == \'1\'}\" ng-click=\"setType(\'1\')\">待收货</button>\n                    <button class=\"btn order-btn col-25\" ng-class=\"{\'active\': orderType == \'2\'}\" ng-click=\"setType(\'2\')\">已完成</button>\n                    <button class=\"btn order-btn col-25\" ng-class=\"{\'active\': orderType == \'3\'}\" ng-click=\"setType(\'3\')\">已取消</button>\n                </div>\n            </div>\n            <div class=\"order-detail\" ng-repeat=\"order in orders track by $index\">\n                <table class=\"table ngCart cart-table\">\n                    <thead>\n                        <tr>\n                            <td class=\"first-cell\" colspan=\"2\">\n                                <button class=\"button button-clear button-dark button-small\">\n                    订单号: {{order.code}}\n                </button>\n                            </td>\n                            <td class=\"detail-cell\">\n                                <a class=\"button button-stable button-small\" style=\"background-color: #fff;\" ng-href=\"#/order/{{order.code}}\">详情 <i class=\"icon ion-ios-arrow-right\"></i></a>\n                            </td>\n                        </tr>\n                    </thead>\n\n                    <tbody>\n                        <tr ng-repeat=\"entry in order.detailList track by $index\" style=\"border:0 none; background-color:#f9f9f9\">\n\n                            <td class=\"img-cell\">\n                                <div>\n                                    <a ng-href=\"#/item/{{entry.maProId}}\">\n                                        <img ng-src=\"{{entry.maProImg}}\">\n                                    </a>\n                                </div>\n                            </td>\n                            <td class=\"info-cell\">\n                                <div>{{ entry.maProName }}</div>\n                            </td>\n                            <td class=\"price-cell\">\n                                {{ entry.dealPrice | currency:\'￥\' }}\n                                <div style=\"color:#333\">\n                                    <span>x {{ entry.num | number }}</span>\n                                </div>\n                            </td>\n                        </tr>\n                    </tbody>\n\n                    <tfoot>\n                        <tr>\n                            <td colspan=\"3\" class=\"fee-cell\">运费:\n                                <span class=\"price-cell\">{{ order.trackingAmount | currency:\"￥\" }}</span> 总计:\n                                <span class=\"price-cell\">{{ order.totalAmount | currency:\"￥\" }}</span>\n                            </td>\n                        </tr>\n                        <tr style=\"height:40px\">\n                            <td colspan=\"3\" class=\"status-cell\" style=\"text-align:right;padding-right:10px;\">\n                                <a class=\"button button-default button-small\" style=\"border:1px solid #aaa\" ng-if=\"order.status==\'0\'\" ng-click=\"orderCancel(order)\">\n                                    取消订单\n                                </a>\n                                <a class=\"button button-default button-small\" style=\"border:1px solid #aaa\" ng-if=\"order.status==\'1\' || order.status==\'2\'\" ng-href=\"#/order/logistics/{{order.code}}\">\n                                    查看物流\n                                </a>\n                                <a class=\"button button-energized button-small\" ng-if=\"order.status==\'0\'\" ng-href=\"#/order/{{order.code}}\">\n                                    去付款\n                                </a>\n                                <a class=\"button button-energized button-small\" ng-if=\"order.status==\'1\' || order.status==\'2\'\" ng-click=\"orderDone(order)\">\n                                    确认收货\n                                </a>\n                                <a class=\"button button-energized button-small\" ng-if=\"order.status==\'3\'\" ng-click=\"orderDel(order)\">\n                                    删除订单\n                                </a>\n                            </td>\n                        </tr>\n                    </tfoot>\n                </table>\n\n            </div>\n        </section>\n    </ion-content>\n</ion-view>");
